...
var delta = [ 0, 0 ];
var stage = [ window.screenX, window.screenY, 0, 0 ];
...
var themes = [["#000","#EBBC5E","#EBBC5E","#EBBC5E","#EBBC5E"],["#000","#8C3F3F","#8C3F3F","#8C3F3F","#8C3F3F"],["#000","#95AB63","#95AB63","#95AB63","#95AB63"]]
var theme;
...
function init() {
    ...
    worldAABB.maxVertex.Set( 1024+200, 400+200 );
